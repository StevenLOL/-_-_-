...
OEVENTLUA[31020] = function() --武当入门
    if PDReq(0, "品德", 90, 100) and JY.Person[zj()]["实战"] >= 50 and MPPD(0) == 0 and PJPD(4) == false then
		Cls()
		...
		Cls()
		say("少侠武功已到如此境界，老朽也没什麽好教你的了。",5,0,"张三丰")		
	end
end
...
OEVENTLUA[31030] = function() --少林入门
    if PDReq(0, "品德", 80, 100) and MPPD(0) == 0 and PJPD(5) == false and JY.Person[0]["性别"] == 0 then
		...
		say("晚辈拜见空见大师。")			
		Cls()
		say("老衲看小施主颇有慧根，更难得的是人品清正。不知小施主可否愿意拜入少林门下？",169,0,"空见")
...
OEVENTLUA[31031] = function() --少林入门
	if MPPD(0) == 5 and MPDJ(0) == 3 then
		Cls()
		say("阿弥陀佛，为师盼望你能尽己所学造福武林。",169,0,"空见")	
		Cls()
		say("是！师父！")		
		do return end	
	end
	if MPPD(0) == 5 and MPDJ(0) == 2 and hasthing(85) then
		Cls()
		say("阿弥陀佛。既然你已经通过铜人巷，证明你已可以出师了。",169,0,"空见")		
		Cls()
		say("分别在即，为师就再传你一些功夫，对你行走江湖应该有用。",169,0,"空见")
		Cls()
		say("谢谢师父！")			
		JoinMP(0, 5, 3)		
		Cls()
		...
		Cls()
		say("好了，你已经可以下山了。为师盼望你能尽己所学造福武林。",169,0,"空见")	
		Cls()
		say("是！师父！")		
		do return end
	end		
	if MPPD(0) == 5 and MPDJ(0) == 1 and hasthing(168) then
		Cls()
		say("阿弥陀佛。你竟然能够在短短时日之内通过木人巷，真是后生可畏。",169,0,"空见")		
		Cls()
		say("这多亏了师父悉心教诲。")			
		JoinMP(0, 5, 2)		
		Cls()
		say("我今天就传给你更深的武功，希望你勤加练习。",169,0,"空见")			
		Cls()
		say("是！")	
		Cls()
		QZXS(JY.Person[zj()]["姓名"].."对少林武学领悟加深！")		
